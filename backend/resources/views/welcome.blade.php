...
*/
    ...
    <style>
        #frame-0 .hljs-ln-line[data-line-number='67'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-1 .hljs-ln-line[data-line-number='36'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-2 .hljs-ln-line[data-line-number='2449'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-3 .hljs-ln-line[data-line-number='35'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-4 .hljs-ln-line[data-line-number='53'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-5 .hljs-ln-line[data-line-number='31'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-6 .hljs-ln-line[data-line-number='96'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-7 .hljs-ln-line[data-line-number='81'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-8 .hljs-ln-line[data-line-number='81'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-10 .hljs-ln-line[data-line-number='265'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-11 .hljs-ln-line[data-line-number='211'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-14 .hljs-ln-line[data-line-number='50'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-15 .hljs-ln-line[data-line-number='208'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-16 .hljs-ln-line[data-line-number='126'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-21 .hljs-ln-line[data-line-number='200'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-22 .hljs-ln-line[data-line-number='169'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-31 .hljs-ln-line[data-line-number='109'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-33 .hljs-ln-line[data-line-number='61'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-39 .hljs-ln-line[data-line-number='26'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-41 .hljs-ln-line[data-line-number='126'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-42 .hljs-ln-line[data-line-number='175'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-43 .hljs-ln-line[data-line-number='144'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-44 .hljs-ln-line[data-line-number='1219'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-45 .hljs-ln-line[data-line-number='20'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-46 .hljs-ln-line[data-line-number='23'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
    </style>
</head>
...
>
                ...
                <section
                    ...
                    BadMethodCallException
                            ...
                            <div
                                ...
                                Call to undefined method App\Models\BorrowRequestModel::mapInto()
                            </div>
                        </div>
  ...
  <path fill-rule="evenodd" d="M9.47 6.47a.75.75 0 0 1 1.06 0l4.25 4.25a.75.75 0 1 1-1.06 1.06L10 8.06l-3.72 3.72a.75.75 0 0 1-1.06-1.06l4.25-4.25Z" clip-rule="evenodd" />
                        ...
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Support\Traits\ForwardsCalls</span>
                        ...
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    ...
                                    <span class="font-mono text-xs">:2449</span>
                                </span>
                            </div>
                            <div class="text-gray-500 dark:text-gray-400">
                                __call
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Http\Resources\CollectsResources</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Http\Resources\Json\ResourceCollection</span>
                                    <span class="font-mono text-xs">:53</span>
                                </span>
                            </div>
                            <div class="text-gray-500 dark:text-gray-400">
                                __construct
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Http\Resources\Json\AnonymousResourceCollection</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Http\Resources\Json\JsonResource</span>
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Http\Resources\Json\JsonResource</span>
                                    <span class="font-mono text-xs">:81</span>
                                </span>
                            </div>
                            <div class="text-gray-500 dark:text-gray-400">
                                collection
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">D:\User\Program files\Tools\xampp\htdocs\toolshare-system\backend\app\Http\Controllers\BorrowRequestController.php</span>
                                    <span class="font-mono text-xs">:81</span>
                                </span>
                            </div>
                            <div class="text-gray-500 dark:text-gray-400">
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">D:\User\Program files\Tools\xampp\htdocs\toolshare-system\backend\vendor\laravel\framework\src\Illuminate\Support\Traits\ForwardsCalls.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">D:\User\Program files\Tools\xampp\htdocs\toolshare-system\backend\vendor\laravel\framework\src\Illuminate\Database\Eloquent\Model.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">D:\User\Program files\Tools\xampp\htdocs\toolshare-system\backend\vendor\laravel\framework\src\Illuminate\Http\Resources\CollectsResources.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">D:\User\Program files\Tools\xampp\htdocs\toolshare-system\backend\vendor\laravel\framework\src\Illuminate\Http\Resources\Json\ResourceCollection.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">D:\User\Program files\Tools\xampp\htdocs\toolshare-system\backend\vendor\laravel\framework\src\Illuminate\Http\Resources\Json\AnonymousResourceCollection.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">D:\User\Program files\Tools\xampp\htdocs\toolshare-system\backend\vendor\laravel\framework\src\Illuminate\Http\Resources\Json\JsonResource.php</span>
     ...
     * @return \Illuminate\Http\Resources\Json\AnonymousResourceCollection
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">D:\User\Program files\Tools\xampp\htdocs\toolshare-system\backend\app\Http\Controllers\BorrowRequestController.php</span>
                ...
                >    {
        try {
            $request = BorrowRequestModel::with(&#039;user&#039;, &#039;handledBy&#039;, &#039;items&#039;, &#039;summary&#039;)-&gt;findOrFail($id);
            return response()-&gt;json([
                &#039;message&#039; =&gt; &#039;Borrow Requests retrieved successfully.&#039;,
                &#039;data&#039; =&gt; BorrowRequestResource::collection($request)
            ], 200);
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">D:\User\Program files\Tools\xampp\htdocs\toolshare-system\backend\vendor\laravel\framework\src\Illuminate\Routing\ControllerDispatcher.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">D:\User\Program files\Tools\xampp\htdocs\toolshare-system\backend\vendor\laravel\framework\src\Illuminate\Routing\Route.php</span>
...
require_once $publicPath.&#039;/index.php&#039;;
                ...
                <section
                    ...
                    <div class="mt-2">
                        <span>GET</span>
                        <span class="text-gray-500">/api/borrow-requests/2</span>
                    </div>
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">88ec7d38-493e-485c-b4fa-53c526250d16</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
            ...
            >
                ...
                <section
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">App\Http\Controllers\BorrowRequestController@show</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">borrow-requests.show</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
    ...
    &quot;borrow_request&quot;: &quot;2&quot;
                    ...
                    <dl class="mt-1 grid grid-cols-1 rounded border dark:border-gray-800">
                        <div class="flex items-center gap-2  dark:border-gray-800">
                            <div
                                ...
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(4.39 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `tbl_borrow_requests` where `tbl_borrow_requests`.`request_id` = &#039;2&#039; limit 1</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <div
                                class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(0.67 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `tbl_users` where `tbl_users`.`user_id` in (4)</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <div
                                class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(0.64 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `tbl_borrow_request_items` where `tbl_borrow_request_items`.`request_id` in (2)</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <div
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `tbl_borrow_request_summary` where `tbl_borrow_request_summary`.`request_id` in (2)</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <div
                                class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(0.73 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `tbl_borrow_requests` limit 1</code></pre>
                </span>
                        </div>
                    </dl>
                </section>
