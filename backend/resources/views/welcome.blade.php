                ...
                <section
                    ...
                    MethodNotAllowedHttpException
                            ...
                            <div
                                ...
                                The PUT method is not supported for route api/borrow-request-items. Supported methods:
                                GET, HEAD, POST.
                            </div>
                        </div>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">D:\User\Program files\Tools\xampp\htdocs\toolshare-system\backend\vendor\laravel\framework\src\Illuminate\Routing\AbstractRouteCollection.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">D:\User\Program files\Tools\xampp\htdocs\toolshare-system\backend\vendor\laravel\framework\src\Illuminate\Routing\RouteCollection.php</span>
...
require_once $publicPath.&#039;/index.php&#039;;
                ...
                <section
                    ...
                    <div class="mt-2">
                        <span>PUT</span>
                        <span class="text-gray-500">/api/borrow-request-items</span>
                    </div>
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">5f2afd8a-a86c-4d73-a93c-886f7a50f7fa</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
