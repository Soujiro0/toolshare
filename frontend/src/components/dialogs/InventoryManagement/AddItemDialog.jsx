            ...
            <DialogContent width="max-w-7xl">
                ...
                <div className="grid gap-3">
                    <div className="flex w-full gap-2">
                        <div className="w-full max-h-[100px] grid gap-3">
                                                ...
                                                <div key={originalIndex} className="border p-4 rounded-md space-y-3 bg-muted/20">
                                                    ...
                                                    {hasMultipleUnits && formData.units.length > 1 && (
                                                        <div className="text-right">
                                                            <Button variant="destructive" size="sm" onClick={() => removeUnit(originalIndex)}>
                                                                Remove Unit
                                                            </Button>
                                                        </div>
                                                    )}
                                                    ...
                                                    <div className="grid md:grid-cols-2 gap-4">
                                                        ...
                                                        <div className="flex flex-col gap-2 w-fit">
                                                            ...
                                                            <div className="flex items-center gap-2 w-fit">
                                                                <Input
                                                                    type="number"
                                                                    value={unit.quantity}
                                                                    onChange={(e) => handleUnitChange(originalIndex, "quantity", e.target.value)}
                                                                    min="1"
                                                                    className="w-24"
                                                                />
                                                        ...
                                                        <div className="flex flex-col gap-2">
                                                            ...
                                                            <Select
                                                                ...
                                                                onValueChange={(val) => handleUnitChange(originalIndex, "item_condition", val)}
                                                            >
                                                                <SelectTrigger>
