...
export function InventoryDataTable({ columns, data, onViewDetails, openAddItem, loading }) {
    ...
    const exportData = (format) => {
        ...
        saveAs(blob, `inventory_management.${format}`);
    };
    ...
    return (
        <div className="p-4">
            <div className="flex gap-4 mb-4 items-center">
                ...
                <Button className="ml-auto" onClick={() => openAddItem(true)}>
                    <Plus /> Add New Item
                </Button>
            </div>
                ...
                <TableBody>
                    {loading ? (
                        ...
                        table.getRowModel().rows.map((row) => (
                            <TableRow key={row.id} className="cursor-pointer hover:bg-gray-100" onClick={() => onViewDetails(row.original)}>
